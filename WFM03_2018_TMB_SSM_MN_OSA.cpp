...
// template <class Type>
// Type dmultinom_osa_EML(vector<Type> x, vector<Type> p, data_indicator<vector<Type>, Type> keep)
// {
//   Type logres = 0;
//   vector<Type> k=keep;
...
Type objective_function<Type>::operator() ()
{
  ...
  DATA_VECTOR(in_obs_PAT); //Observed proportion at age
  DATA_VECTOR_INDICATOR(keepPAT,in_obs_PAT); //Observed proportion at age Keep term
  ...
  DATA_VECTOR_INDICATOR(keepHarvT,in_harvT);
  ...
  DATA_VECTOR(in_obs_PAG); //Observed proportion at age
  DATA_VECTOR_INDICATOR(keepPAG,in_obs_PAG); //Observed proportion at age Keep term
  ...
  DATA_VECTOR_INDICATOR(keepHarvG,in_harvG);
  ...
  matrix<Type> residPAT(ryears.size(),ages.size());
  matrix<Type> residPAG(ryears.size(),ages.size());
  ...
  obs_PAT(0,0) = in_obs_PAT(0);obs_PAT(0,1) = in_obs_PAT(1);obs_PAT(0,2) = in_obs_PAT(2);obs_PAT(0,3) = in_obs_PAT(3);obs_PAT(0,4) = in_obs_PAT(4);obs_PAT(0,5) = in_obs_PAT(5);
  obs_PAT(1,0) = in_obs_PAT(6);obs_PAT(1,1) = in_obs_PAT(7);obs_PAT(1,2) = in_obs_PAT(8);obs_PAT(1,3) = in_obs_PAT(9);obs_PAT(1,4) = in_obs_PAT(10);obs_PAT(1,5) = in_obs_PAT(11);obs_PAT(1,6) = in_obs_PAT(12);
  obs_PAT(2,0) = in_obs_PAT(13);obs_PAT(2,1) = in_obs_PAT(14);obs_PAT(2,2) = in_obs_PAT(15);obs_PAT(2,3) = in_obs_PAT(16);obs_PAT(2,4) = in_obs_PAT(17);obs_PAT(2,5) = in_obs_PAT(18);obs_PAT(2,6) = in_obs_PAT(19); obs_PAT(2,7) = in_obs_PAT(20);
  obs_PAT(3,0) = in_obs_PAT(21);obs_PAT(3,1) = in_obs_PAT(22);obs_PAT(3,2) = in_obs_PAT(23);obs_PAT(3,3) = in_obs_PAT(24);obs_PAT(3,4) = in_obs_PAT(25);obs_PAT(3,5) = in_obs_PAT(26);obs_PAT(3,6) = in_obs_PAT(27);obs_PAT(3,7) = in_obs_PAT(28);obs_PAT(3,8) = in_obs_PAT(29);
  obs_PAT(4,0) = in_obs_PAT(30);obs_PAT(4,1) = in_obs_PAT(31);obs_PAT(4,2) = in_obs_PAT(32);obs_PAT(4,3) = in_obs_PAT(33);obs_PAT(4,4) = in_obs_PAT(34);obs_PAT(4,5) = in_obs_PAT(35);obs_PAT(4,6) = in_obs_PAT(36);obs_PAT(4,7) = in_obs_PAT(37);obs_PAT(4,8) = in_obs_PAT(38);obs_PAT(4,9) = in_obs_PAT(39);
  obs_PAT(5,0) = in_obs_PAT(40);obs_PAT(5,1) = in_obs_PAT(41);obs_PAT(5,2) = in_obs_PAT(42);obs_PAT(5,3) = in_obs_PAT(43);obs_PAT(5,4) = in_obs_PAT(44);obs_PAT(5,5) = in_obs_PAT(45);obs_PAT(5,6) = in_obs_PAT(46);obs_PAT(5,7) = in_obs_PAT(47);obs_PAT(5,8) = in_obs_PAT(48);obs_PAT(5,9) = in_obs_PAT(49);obs_PAT(5,10) = in_obs_PAT(50);
  obs_PAG(0,0) = in_obs_PAG(0);obs_PAG(0,1) = in_obs_PAG(1);obs_PAG(0,2) = in_obs_PAG(2);obs_PAG(0,3) = in_obs_PAG(3);obs_PAG(0,4) = in_obs_PAG(4);obs_PAG(0,5) = in_obs_PAG(5);
  obs_PAG(1,0) = in_obs_PAG(6);obs_PAG(1,1) = in_obs_PAG(7);obs_PAG(1,2) = in_obs_PAG(8);obs_PAG(1,3) = in_obs_PAG(9);obs_PAG(1,4) = in_obs_PAG(10);obs_PAG(1,5) = in_obs_PAG(11);obs_PAG(1,6) = in_obs_PAG(12);
  obs_PAG(2,0) = in_obs_PAG(13);obs_PAG(2,1) = in_obs_PAG(14);obs_PAG(2,2) = in_obs_PAG(15);obs_PAG(2,3) = in_obs_PAG(16);obs_PAG(2,4) = in_obs_PAG(17);obs_PAG(2,5) = in_obs_PAG(18);obs_PAG(2,6) = in_obs_PAG(19); obs_PAG(2,7) = in_obs_PAG(20);
  obs_PAG(3,0) = in_obs_PAG(21);obs_PAG(3,1) = in_obs_PAG(22);obs_PAG(3,2) = in_obs_PAG(23);obs_PAG(3,3) = in_obs_PAG(24);obs_PAG(3,4) = in_obs_PAG(25);obs_PAG(3,5) = in_obs_PAG(26);obs_PAG(3,6) = in_obs_PAG(27);obs_PAG(3,7) = in_obs_PAG(28);obs_PAG(3,8) = in_obs_PAG(29);
  obs_PAG(4,0) = in_obs_PAG(30);obs_PAG(4,1) = in_obs_PAG(31);obs_PAG(4,2) = in_obs_PAG(32);obs_PAG(4,3) = in_obs_PAG(33);obs_PAG(4,4) = in_obs_PAG(34);obs_PAG(4,5) = in_obs_PAG(35);obs_PAG(4,6) = in_obs_PAG(36);obs_PAG(4,7) = in_obs_PAG(37);obs_PAG(4,8) = in_obs_PAG(38);obs_PAG(4,9) = in_obs_PAG(39);
  obs_PAG(5,0) = in_obs_PAG(40);obs_PAG(5,1) = in_obs_PAG(41);obs_PAG(5,2) = in_obs_PAG(42);obs_PAG(5,3) = in_obs_PAG(43);obs_PAG(5,4) = in_obs_PAG(44);obs_PAG(5,5) = in_obs_PAG(45);obs_PAG(5,6) = in_obs_PAG(46);obs_PAG(5,7) = in_obs_PAG(47);obs_PAG(5,8) = in_obs_PAG(48);obs_PAG(5,9) = in_obs_PAG(49);obs_PAG(5,10) = in_obs_PAG(50);
  
  for(i=6;i<=ryears.size()-1;i++)
  {
    obs_PAT.row(i) = in_obs_PAT.segment((i*12-21),12);
    obs_PAG.row(i) = in_obs_PAG.segment((i*12-21),12);
  }
  // obs_PAT = 0;
  // obs_PAG = 0;
  for(i=0;i<=ryears.size()-1;i++)
  {
    ...
    //   for(j=0;j<=i+5;j++)
    //   {
    //     // obs_PAT(i,j) = in_obs_PAT(i*12+j)/N_SampT(i);
    //     obs_PAT(i,j) = in_obs_PAT(i*(i+5)+j);
    //   }
    // } 
    // for(j=0;j<=ages.size()-1;j++)
    // {
    //   // obs_PAT(i,j) = in_obs_PAT(i*12+j)/N_SampT(i);
    //   obs_PAT(i,j) = in_obs_PAT(i*12+j-9);
    // }
    ...
    // for(j=0;j<=ages.size()-1;j++)
    // {
    //   // obs_PAG(i,j) = in_obs_PAG(i*12+j)/N_SampG(i);
    //   obs_PAG(i,j) = in_obs_PAG(i*12+j);
    // }
  ...
  for(i=0;i<=ryears.size()-1;i++)
  {
    for(j=0;j<=ages.size()-1;j++)
    {
      residPAT(i,j)=((obs_PAT(i,j)/N_SampT(i))-PAT(i,j))/denomT(i,j);
      residPAG(i,j)=((obs_PAG(i,j)/N_SampG(i))-PAG(i,j))/denomG(i,j);
    }
  }
  ...
  for(i=0;i<=ryears.size()-1;i++)
  {
    NLL+=keepHarvT(i)*0.5/pow(sd_logCT,2.0)*pow(log((.01+obs_CT(i))/(.01+CT(i))),2.0) + log(sd_logCT);
  }
  //std::cout<<"NLL Trap Catch Total: "<<NLL<<std::endl;
  
  for(i=0;i<=ryears.size()-1;i++)
  {
    NLL+=keepHarvG(i)*0.5/pow(sd_logCG,2.0)*pow(log((.01+obs_CG(i))/(.01+CG(i))),2.0) + log(sd_logCG);
  }
  //std::cout<<"NLL Trap and Gill Catch Total: "<<NLL<<std::endl;
  
  // std::cout<<"keepPAT: "<<keepPAT<<std::endl;
  // std::cout<<"obs_PAT: "<<obs_PAT<<std::endl;
  // std::cout<<"PAT: "<<PAT<<std::endl;
  
  // matrix<Type> PAT_adjust(ryears.size(),ages.size());
  // matrix<Type> PAG_adjust(ryears.size(),ages.size());
  // for(i=0;i<=ryears.size()-1;i++)
  // {
  //   for(j=0;j<=ages.size()-1;j++)
  //   {
  //     PAT_adjust(i,j) = PAT(i,j) + 0.0001;
  //     PAG_adjust(i,j) = PAG(i,j) + 0.0001;
  //   }
  // }
  
  
  // std::cout<<"NLLBefore: "<<NLL<<std::endl;
  vector<Type> obs_PAT_OSA0 = obs_PAT.row(0).segment(0,6);
  vector<Type> PAT_OSA0 = PAT.row(0).segment(0,6);
  NLL-= dmultinom_osa_EML(obs_PAT_OSA0,PAT_OSA0,keepPAT.segment(0,6));
  
  vector<Type> obs_PAT_OSA1 = obs_PAT.row(1).segment(0,7);
  vector<Type> PAT_OSA1 = PAT.row(1).segment(0,7);
  NLL-=dmultinom_osa_EML(obs_PAT_OSA1,PAT_OSA1,keepPAT.segment(6,7));
  
  vector<Type> obs_PAT_OSA2 = obs_PAT.row(2).segment(0,8);
  vector<Type> PAT_OSA2 = PAT.row(2).segment(0,8);
  NLL-=dmultinom_osa_EML(obs_PAT_OSA2,PAT_OSA2,keepPAT.segment(13,8));
  
  // std::cout<<"obs_PAT.row(3).segment(0,9): "<<obs_PAT.row(3).segment(0,9)<<std::endl;
  // std::cout<<"PAT.row(3).segment(0,9): "<<PAT.row(3).segment(0,9)<<std::endl;
  
  vector<Type> obs_PAT_OSA3 = obs_PAT.row(3).segment(0,9);
  vector<Type> PAT_OSA3 = PAT.row(3).segment(0,9);
  NLL-=dmultinom_osa_EML(obs_PAT_OSA3,PAT_OSA3,keepPAT.segment(21,9));
  
  vector<Type> obs_PAT_OSA4 = obs_PAT.row(4).segment(0,10);
  vector<Type> PAT_OSA4 = PAT.row(4).segment(0,10);
  NLL-=dmultinom_osa_EML(obs_PAT_OSA4,PAT_OSA4,keepPAT.segment(30,10));
  
  vector<Type> obs_PAT_OSA5 = obs_PAT.row(5).segment(0,11);
  vector<Type> PAT_OSA5 = PAT.row(5).segment(0,11);
  NLL-=dmultinom_osa_EML(obs_PAT_OSA5,PAT_OSA5,keepPAT.segment(40,11));
  
  vector<Type> obs_PAG_OSA0 = obs_PAG.row(0).segment(0,6);
  vector<Type> PAG_OSA0 = PAG.row(0).segment(0,6);
  NLL-= dmultinom_osa_EML(obs_PAG_OSA0,PAG_OSA0,keepPAG.segment(0,6));
  
  vector<Type> obs_PAG_OSA1 = obs_PAG.row(1).segment(0,7);
  vector<Type> PAG_OSA1 = PAG.row(1).segment(0,7);
  NLL-=dmultinom_osa_EML(obs_PAG_OSA1,PAG_OSA1,keepPAG.segment(6,7));
  
  vector<Type> obs_PAG_OSA2 = obs_PAG.row(2).segment(0,8);
  vector<Type> PAG_OSA2 = PAG.row(2).segment(0,8);
  NLL-=dmultinom_osa_EML(obs_PAG_OSA2,PAG_OSA2,keepPAG.segment(13,8));
  
  // std::cout<<"obs_PAT.row(3).segment(0,9): "<<obs_PAT.row(3).segment(0,9)<<std::endl;
  // std::cout<<"PAT.row(3).segment(0,9): "<<PAT.row(3).segment(0,9)<<std::endl;
  
  vector<Type> obs_PAG_OSA3 = obs_PAG.row(3).segment(0,9);
  vector<Type> PAG_OSA3 = PAG.row(3).segment(0,9);
  NLL-=dmultinom_osa_EML(obs_PAG_OSA3,PAG_OSA3,keepPAG.segment(21,9));
  
  vector<Type> obs_PAG_OSA4 = obs_PAG.row(4).segment(0,10);
  vector<Type> PAG_OSA4 = PAG.row(4).segment(0,10);
  NLL-=dmultinom_osa_EML(obs_PAG_OSA4,PAG_OSA4,keepPAG.segment(30,10));
  
  vector<Type> obs_PAG_OSA5 = obs_PAG.row(5).segment(0,11);
  vector<Type> PAG_OSA5 = PAG.row(5).segment(0,11);
  NLL-=dmultinom_osa_EML(obs_PAG_OSA5,PAG_OSA5,keepPAG.segment(40,11));
  ...
  for(i=6;i<=ryears.size()-1;i++)
  {
      ...
      vector<Type> obs_PAT_OSA = obs_PAT.row(i);
      vector<Type> PAT_OSA = PAT.row(i);
      NLL-=dmultinom_osa_EML(obs_PAT_OSA,PAT_OSA,keepPAT.segment(i*12-21,12));

      vector<Type> obs_PAG_OSA = obs_PAG.row(i);
      vector<Type> PAG_OSA = PAG.row(i);
      NLL-=dmultinom_osa_EML(obs_PAG_OSA,PAG_OSA,keepPAG.segment(i*12-21,12));
    
    // for(j=0;j<=ages.size()-1;j++)
    // {
    //   if(N_SampT(i)>0)
    //   {
    //     NLL-= keepPAT(i*12+j)*N_SampT(i)*obs_PAT(i,j)*log(.0001+PAT(i,j));
    //   }
    //   if(N_SampG(i)>0)
    //   {
    //     NLL-= keepPAG(i*12+j)*N_SampG(i)*obs_PAG(i,j)*log(.0001+PAG(i,j));
    //   }
    // }
  ...
  // std::cout<<"NLLAfter: "<<NLL<<std::endl;
